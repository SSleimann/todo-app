...
from app.modules.cache.application.dto import AddToCacheDTO, CacheDataDTO, UpdateToCacheDTO
...
firstEntity = CacheDataEntity(id=CacheDataEntity.next_id(), data=bytes("testing", "utf-8"))
...
def test_delete_service_cache():
    ...
    entity = CacheDataEntity(id=CacheDataEntity.next_id(), data=bytes("testing", "utf-8"))
    repo.create(entity)
